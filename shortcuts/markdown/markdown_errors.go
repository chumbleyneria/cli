...
func markdownInvalidResponseError(format string, args ...any) *errs.InternalError {
...
func markdownUploadRequestError(err error, action string) error {
	return markdownPrefixProblem(client.WrapDoAPIError(err), action)
}
